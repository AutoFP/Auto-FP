...
def run_bohb(dataset, classifier, max_time_limit, max_len, seed):
    output_dir = make_output_dir(dataset, classifier, max_time_limit, algorithm='BOHB')
...
if __name__ == "__main__":
    ...
    run_bohb(dataset, classifier, max_time_limit, max_len, seed)