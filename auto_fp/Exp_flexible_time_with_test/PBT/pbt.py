...
def run_pbt(dataset, classifier, max_time_limit, max_len, seed):
    output_dir = make_output_dir(dataset, classifier, max_time_limit, algorithm='PBT')
    ...
    while (len(population) < population_size):
        ...
        f = open(f'{output_dir}/pbt_pick_time_{seed}.csv', 'a')
        f.write(str(pick_time) + "\n")
        f = open(f'{output_dir}/pbt_wallock_{seed}.csv', 'a')
        f.write(str(global_mid - global_start) + "\n")
        f = open(f'{output_dir}/pbt_pipe_{seed}.csv', 'a')
        f.write(prep_pipe_str + "\n")
        f = open(f'{output_dir}/pbt_score_{seed}.csv', 'a')
        f.write(str(score) + "\n")
        f = open(f'{output_dir}/pbt_eval_time_{seed}.csv', 'a')
...
if __name__ == "__main__":
    ...
    run_pbt(dataset, classifier, max_time_limit, max_len, seed)
