...
def run_tevo_y(dataset, classifier, max_time_limit, max_len, seed):
    output_dir = make_output_dir(dataset, classifier, max_time_limit, algorithm='TEVO_Y')
    ...
    while (len(population) < P):
        ...
        f = open(f'{output_dir}//younger_pick_time_{seed}.csv', 'a')
        f.write(str(pick_time) + "\n")
        f = open(f'{output_dir}//younger_wallock_{seed}.csv', 'a')
        f.write(str(global_mid - global_start) + "\n")
        f = open(f'{output_dir}//younger_pipe_{seed}.csv', 'a')
        f.write(prep_pipe_str + "\n")
        f = open(f'{output_dir}//younger_score_{seed}.csv', 'a')
        f.write(str(score) + "\n")
        f = open(f'{output_dir}//younger_eval_time_{seed}.csv', 'a')
...
if __name__ == "__main__":
    ...
    run_tevo_y(dataset, classifier, max_time_limit, max_len, seed)