...
def run_hyperband(dataset, classifier, max_time_limit, max_len, seed, eta_value, budget_value):
    output_dir = make_output_dir_hb_vary_eta_and_budget(dataset, classifier, max_time_limit, algorithm='HYPERBAND')
...
if __name__ == "__main__":
    ...
    run_hyperband(dataset, classifier, max_time_limit, max_len, seed, eta_value, budget_value)
