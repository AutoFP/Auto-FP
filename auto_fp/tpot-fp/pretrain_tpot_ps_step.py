...
def tpot_ps_steps_job(classifier, pretrain_mins, round_th, seed, dataset):
    simple_config_dict = {
    ...
    tpot.export('tpot_' + classifier + '_ps_step_' + pretrain_mins + 'min/round_' + round_th + '/seed_' + seed + '/tpot_' + dataset + '_pipeline.py')
...
if __name__ == "__main__":
    ...
    result = Parallel(n_jobs=75)(delayed(tpot_ps_steps_job)(classifier, pretrain_mins, round_th, seed, dataset) \
