...
def run_pbt_extended_space_imbalanced(dataset, classifier, max_time_limit, max_len, seed):
    output_dir = make_output_dir_extended_space(\
        dataset, classifier, max_time_limit, \
        algorithm='PBT', type=('imbalanced', 'one-step'))
...
if __name__ == "__main__":
    ...
    run_pbt_extended_space_imbalanced(dataset, classifier, max_time_limit, max_len, seed)